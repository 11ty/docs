...
- <small><code>Sep<!-- --> 2018</code></small> [Google’s {% indieavatar "https://v8.dev/" %}V8 website launches using Eleventy]({{ "https://twitter.com/v8js/status/1044202940494475265" | canonicalTwitterUrl }})
